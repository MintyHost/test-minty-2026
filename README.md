...
| Task | Description |
|------|------------|
| Implement new Guest data model | Add a new `create_guests_table.php` migration and implement the relevant `Guest` model. Add relationships to link guests to bookings. |
